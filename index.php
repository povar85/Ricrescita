...
$integration
    ->addProvider(new \Leadrock\Providers\Leadrock('525', 'e50d6fa22d56ce1f52e4779c542860ea'))
    ->findTrackIn('track_id')
    ->setWebmasterLink('https://leadrock.com/URL-XXXXX-XXXXX')
    ->addFacebookPixel((new \Leadrock\Items\FacebookPixel('3003463116381376'))->setEvent('PageView'))
